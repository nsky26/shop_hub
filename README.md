...
- 📱 **100% Mobile Responsive**: Optimized for desktops, tablets, and smartphones.
...
├── css/
│   └── style.css     # Production CSS design system & micro-animations
├── js/
│   ├── products.js   # Product data model & dynamic generator
│   ├── cart.js       # Cart calculation engine & state sync
│   └── script.js     # Event router, search, and notification popups
├── CONTRIBUTORS.md   # Project contributors & team credits
...
### Local Execution
You can run ShopHub using any local HTTP server (such as Python `http.server` or Live Server):
